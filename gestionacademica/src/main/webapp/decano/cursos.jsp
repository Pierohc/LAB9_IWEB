...
background: radial-gradient(circle, rgba(45,0,83,1) 0%, rgba(35,3,80,1) 59%, rgba(21,0,48,1) 100%) !important;">
    <div class="text-secondary px-4 py-5 text-center">
        <div class="py-5">
            ...
            <h3 class="fw-bold text-white">Panel de Lista de Cursos de su Facultad</h3>
            <div style="margin-bottom: 20px"></div>
    ...
    <table  class="table table-dark table-hover">
        ...
        <%for (Curso curso : listaCursos){ %>
            <tr>
                ...
                <td class="cell c5" ><a href="<%=request.getContextPath() %>"><img width="24" height="24" src="https://img.icons8.com/pastel-glyph/64/FFFFFF/create-new--v2.png" alt="edit-row"/></a></td>
                <td class="cell c6 "><a  href="<%=request.getContextPath() %>"><img width="24" height="24" src="https://img.icons8.com/material-outlined/24/FFFFFF/filled-trash.png" alt="filled-trash"/></a></td>
            </tr>
        <%}%>
        </tbody>
