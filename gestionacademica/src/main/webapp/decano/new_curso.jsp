...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12" style="text-align: left; padding-top: 1.5em">
            <form id="form" method="post" action="<%=request.getContextPath()%>/decano?action=newCurso">
                <div class="card">
                    <div class="card-body" style="padding-left: 35px">
                        ...
                        <div class="form-group" style="padding-right: 1rem">
                            <label><strong>Docente encargado del curso:</strong></label>

                            <select class="form-select" name="idDocente" aria-label="Default select example" required>

                                <option selected disabled value="">Seleccionar</option>
                                <%for (Usuario usuario : docentesSinCurso){ %>
