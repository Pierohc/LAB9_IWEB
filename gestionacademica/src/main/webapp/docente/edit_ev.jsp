...
background: radial-gradient(circle, rgba(45,0,83,1) 0%, rgba(35,3,80,1) 59%, rgba(21,0,48,1) 100%) !important;">
    <div class="text-secondary px-4 py-5 text-center">
        <div class="py-5">
            ...
            <h3 class="fw-bold text-white">Panel de Edición de Evaluación</h3>
            <div style="margin-bottom: 20px"></div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12" style="text-align: left; padding-top: 1.5em">
            <form  method="post" action="<%=request.getContextPath()%>/docente?action=editEv">
                <div class="card">
                    <div class="card-body" style="padding-left: 35px">
                        ...
                        <div class="form-group" style="padding-right: 1rem">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" value="<%=evaluacion.getNombreEstudiante()%>" required>
                        </div>
                        ...
                        <div class="form-group" style="padding-right: 1rem">
                            ...
                            <input type="text" value="<%=evaluacion.getCodigoEstudiante()%>" class="form-control" name="codigo" required>
                        </div>
                        ...
                        <div class="form-group" style="padding-right: 1rem">
                            ...
                            <input type="email" value="<%=evaluacion.getCorreoEstudiante()%>" class="form-control" name="correo" required>
                        </div>
                        ...
                        <div class="form-group" style="padding-right: 1rem">
                            ...
                            <input type="number" value="<%=evaluacion.getNota()%>" class="form-control" name="nota" required>
                            <input type="hidden" value="<%=evaluacion.getIdevaluacion()%>" class="form-control" name="idEv" required>
                ...
                <div class="uk-flex uk-flex-center uk-margin-top">
                    <div class="uk-flex uk-flex-center">
                        <a id="redirect-button" class="btn btn-secondary m-2" href="<%=request.getContextPath()%>/docente?action=home">Cancelar</a>
